                ...
                <div class="row">
                    <div class="col-md-4 stretch-card grid-margin">
                        <div class="card bg-gradient-danger card-img-holder text-white">
                            <div class="card-body">
                                <img src="{{ asset('assets/auth/images/dashboard/circle.svg') }}"
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="{{ asset('assets/auth/images/faces/face1.jpg') }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{ asset('assets/auth/images/faces/face2.jpg') }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{ asset('assets/auth/images/faces/face4.jpg') }}"
